...
ggplot(data=ngram.1.freq[1:10,], aes(x=ngram, y=freq)) + geom_bar(stat='identity') + coord_flip()
...
ngrams.2 <- names(freq.2)
wordcloud(ngrams.2[1:50], freq.2[1:50])
...
ngrams.3 <- names(freq.3)
wordcloud(ngrams.3[1:30], freq.3[1:30])
```
